...
pub const struct_hdr_metadata_infoframe = extern struct {
    eotf: __u8,
    metadata_type: __u8,
    display_primaries: [3]struct_unnamed_9,
    white_point: struct_unnamed_10,
...
pub const struct__drmDevice = extern struct {
    ...
    bustype: c_int,
    businfo: union_unnamed_13,
    deviceinfo: union_unnamed_14,
};
...
pub export fn add_property(arg_drm_fd: c_int, arg_req: ?*drmModeAtomicReq, arg_object_id: u32, arg_object_type: u32, arg_prop_name: [*c]const u8, arg_value: u64) void {
    var drm_fd = arg_drm_fd;
    var req = arg_req;
    var object_id = arg_object_id;
    var object_type = arg_object_type;
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (prop_id != @as(u32, @bitCast(@as(c_int, 0)))) {} else {
                __assert_fail("prop_id != 0", "03-showfb.c", @as(c_uint, @bitCast(@as(c_int, 51))), "void add_property(int, drmModeAtomicReq *, uint32_t, uint32_t, const char *, uint64_t)");
            };
        };
    };
    _ = drmModeAtomicAddProperty(req, object_id, prop_id, value);
}
pub export fn main(arg_argc: c_int, arg_argv: [*c][*c]u8) c_int {
    ...
    if (drmSetClientCap(drm_fd, @as(u64, @bitCast(@as(c_long, @as(c_int, 3)))), @as(u64, @bitCast(@as(c_long, @as(c_int, 1))))) != @as(c_int, 0)) {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (crtc != @as([*c]drmModeCrtc, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {} else {
                __assert_fail("crtc != NULL", "03-showfb.c", @as(c_uint, @bitCast(@as(c_int, 84))), "int main(int, char **)");
            };
        };
    };
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (plane != @as([*c]drmModePlane, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {} else {
                __assert_fail("plane != NULL", "03-showfb.c", @as(c_uint, @bitCast(@as(c_int, 104))), "int main(int, char **)");
            };
        };
    };
    ...
    var create: struct_drm_mode_create_dumb = struct_drm_mode_create_dumb{
        .height = @as(__u32, @bitCast(height)),
        .width = @as(__u32, @bitCast(width)),
        .bpp = @as(__u32, @bitCast(@as(c_int, 32))),
        .flags = @import("std").mem.zeroes(__u32),
        .handle = @import("std").mem.zeroes(__u32),
        .pitch = @import("std").mem.zeroes(__u32),
        .size = @import("std").mem.zeroes(__u64),
    };
    _ = drmIoctl(drm_fd, @as(c_ulong, @bitCast(@as(c_ulong, (((@as(c_uint, 2) | @as(c_uint, 1)) << @intCast(((@as(c_int, 0) + @as(c_int, 8)) + @as(c_int, 8)) + @as(c_int, 14))) | @as(c_uint, @bitCast(@as(c_int, 'd') << @intCast(@as(c_int, 0) + @as(c_int, 8))))) | @as(c_uint, @bitCast(@as(c_int, 178) << @intCast(0)))))) | (@sizeOf(struct_drm_mode_create_dumb) << @intCast((@as(c_int, 0) + @as(c_int, 8)) + @as(c_int, 8))), @as(?*anyopaque, @ptrCast(&create)));
    ...
    var fb_id: u32 = 0;
    _ = drmModeAddFB2(drm_fd, @as(u32, @bitCast(width)), @as(u32, @bitCast(height)), ((@as(__u32, @bitCast(@as(c_int, 'X'))) | (@as(__u32, @bitCast(@as(c_int, 'R'))) << @intCast(8))) | (@as(__u32, @bitCast(@as(c_int, '2'))) << @intCast(16))) | (@as(__u32, @bitCast(@as(c_int, '4'))) << @intCast(24)), @as([*c]u32, @ptrCast(@alignCast(&handles))), @as([*c]u32, @ptrCast(@alignCast(&strides))), @as([*c]u32, @ptrCast(@alignCast(&offsets))), &fb_id, @as(u32, @bitCast(@as(c_int, 0))));
    _ = printf("Allocated FB %u\n", fb_id);
    var map: struct_drm_mode_map_dumb = struct_drm_mode_map_dumb{
        .handle = handle,
        .pad = @import("std").mem.zeroes(__u32),
        .offset = @import("std").mem.zeroes(__u64),
    };
    _ = drmIoctl(drm_fd, @as(c_ulong, @bitCast(@as(c_ulong, (((@as(c_uint, 2) | @as(c_uint, 1)) << @intCast(((@as(c_int, 0) + @as(c_int, 8)) + @as(c_int, 8)) + @as(c_int, 14))) | @as(c_uint, @bitCast(@as(c_int, 'd') << @intCast(@as(c_int, 0) + @as(c_int, 8))))) | @as(c_uint, @bitCast(@as(c_int, 179) << @intCast(0)))))) | (@sizeOf(struct_drm_mode_map_dumb) << @intCast((@as(c_int, 0) + @as(c_int, 8)) + @as(c_int, 8))), @as(?*anyopaque, @ptrCast(&map)));
    ...
    var req: ?*drmModeAtomicReq = drmModeAtomicAlloc();
    ...
    var ret: c_int = drmModeAtomicCommit(drm_fd, req, flags, @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))));
    if (ret != @as(c_int, 0)) {
...
pub const fourcc_mod_is_vendor = @compileError("unable to translate macro: undefined identifier `DRM_FORMAT_MOD_VENDOR_`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:432:9
pub const fourcc_mod_code = @compileError("unable to translate macro: undefined identifier `DRM_FORMAT_MOD_VENDOR_`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:435:9
pub const DRM_FORMAT_MOD_INVALID = @compileError("unable to translate macro: undefined identifier `NONE`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:478:9
pub const DRM_FORMAT_MOD_LINEAR = @compileError("unable to translate macro: undefined identifier `NONE`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:488:9
pub const I915_FORMAT_MOD_X_TILED = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:517:9
pub const I915_FORMAT_MOD_Y_TILED = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:535:9
pub const I915_FORMAT_MOD_Yf_TILED = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:550:9
pub const I915_FORMAT_MOD_Y_TILED_CCS = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:569:9
pub const I915_FORMAT_MOD_Yf_TILED_CCS = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:570:9
pub const I915_FORMAT_MOD_Y_TILED_GEN12_RC_CCS = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:581:9
pub const I915_FORMAT_MOD_Y_TILED_GEN12_MC_CCS = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:594:9
pub const I915_FORMAT_MOD_Y_TILED_GEN12_RC_CCS_CC = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:613:9
pub const I915_FORMAT_MOD_4_TILED = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:624:9
pub const I915_FORMAT_MOD_4_TILED_DG2_RC_CCS = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:634:9
pub const I915_FORMAT_MOD_4_TILED_DG2_MC_CCS = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:646:9
pub const I915_FORMAT_MOD_4_TILED_DG2_RC_CCS_CC = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:660:9
pub const I915_FORMAT_MOD_4_TILED_MTL_RC_CCS = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:671:9
pub const I915_FORMAT_MOD_4_TILED_MTL_MC_CCS = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:684:9
pub const I915_FORMAT_MOD_4_TILED_MTL_RC_CCS_CC = @compileError("unable to translate macro: undefined identifier `INTEL`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:703:9
pub const DRM_FORMAT_MOD_SAMSUNG_64_32_TILE = @compileError("unable to translate macro: undefined identifier `SAMSUNG`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:718:9
pub const DRM_FORMAT_MOD_SAMSUNG_16_16_TILE = @compileError("unable to translate macro: undefined identifier `SAMSUNG`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:727:9
pub const DRM_FORMAT_MOD_QCOM_COMPRESSED = @compileError("unable to translate macro: undefined identifier `QCOM`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:740:9
pub const DRM_FORMAT_MOD_QCOM_TILED3 = @compileError("unable to translate macro: undefined identifier `QCOM`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:753:9
pub const DRM_FORMAT_MOD_QCOM_TILED2 = @compileError("unable to translate macro: undefined identifier `QCOM`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:761:9
pub const DRM_FORMAT_MOD_VIVANTE_TILED = @compileError("unable to translate macro: undefined identifier `VIVANTE`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:772:9
pub const DRM_FORMAT_MOD_VIVANTE_SUPER_TILED = @compileError("unable to translate macro: undefined identifier `VIVANTE`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:784:9
pub const DRM_FORMAT_MOD_VIVANTE_SPLIT_TILED = @compileError("unable to translate macro: undefined identifier `VIVANTE`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:793:9
pub const DRM_FORMAT_MOD_VIVANTE_SPLIT_SUPER_TILED = @compileError("unable to translate macro: undefined identifier `VIVANTE`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:802:9
pub const DRM_FORMAT_MOD_NVIDIA_TEGRA_TILED = @compileError("unable to translate macro: undefined identifier `NVIDIA`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:840:9
pub const DRM_FORMAT_MOD_NVIDIA_BLOCK_LINEAR_2D = @compileError("unable to translate macro: undefined identifier `NVIDIA`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:925:9
pub const fourcc_mod_broadcom_code = @compileError("unable to translate macro: undefined identifier `BROADCOM`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:993:9
pub const DRM_FORMAT_MOD_BROADCOM_VC4_T_TILED = @compileError("unable to translate macro: undefined identifier `BROADCOM`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:1021:9
pub const DRM_FORMAT_MOD_BROADCOM_UIF = @compileError("unable to translate macro: undefined identifier `BROADCOM`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:1088:9
pub const DRM_FORMAT_MOD_ARM_CODE = @compileError("unable to translate macro: undefined identifier `ARM`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:1111:9
pub const DRM_FORMAT_MOD_ALLWINNER_TILED = @compileError("unable to translate macro: undefined identifier `ALLWINNER`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:1349:9
pub const DRM_FORMAT_MOD_AMLOGIC_FBC = @compileError("unable to translate macro: undefined identifier `AMLOGIC`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:1376:9
pub const AMD_FMT_MOD = @compileError("unable to translate macro: undefined identifier `AMD`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:1470:9
pub const AMD_FMT_MOD_SET = @compileError("unable to translate macro: undefined identifier `AMD_FMT_MOD_`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:1560:9
pub const AMD_FMT_MOD_GET = @compileError("unable to translate macro: undefined identifier `AMD_FMT_MOD_`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:1562:9
pub const AMD_FMT_MOD_CLEAR = @compileError("unable to translate macro: undefined identifier `AMD_FMT_MOD_`"); // /nix/store/shnla8vp4dx7ams238w32pkxpi702r84-libdrm-2.4.118-dev/include/libdrm/drm_fourcc.h:1564:9
...
pub const MAP_POPULATE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x08000, .hexadecimal);
pub const MAP_NONBLOCK = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x10000, .hexadecimal);
pub const MAP_STACK = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x20000, .hexadecimal);
pub const MAP_HUGETLB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x40000, .hexadecimal);
pub const MAP_SYNC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x80000, .hexadecimal);
pub const MAP_FIXED_NOREPLACE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x100000, .hexadecimal);
...
pub const PROT_GROWSDOWN = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x01000000, .hexadecimal);
pub const PROT_GROWSUP = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x02000000, .hexadecimal);
